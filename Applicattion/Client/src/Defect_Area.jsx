...
const Defect_Area = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/defect_area', formData, {
        headers: {
  ...
  return (
    <>
     ...
     <h2>Automated Detection and Analysis of Defects in Growing Fields for Accurate Agricultural Management</h2>
     </div>
    ...
    <div className='result-component'>
      <div className='result-heading'>
        ...
        <div className='area'>
          {area && <h3>Defect Area Percentage: {area} %</h3>}
